...
kubectl create deployment payments-ms --image=us-east1-docker.pkg.dev/melodic-nature-433213-m1/image-registry/payments-ms --dry-run=client -o yaml > deployment.yml
```
